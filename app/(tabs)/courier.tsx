...
export default function CourierScreen() {
  ...
  const canCourierAction = Boolean(orderAddress.trim());

  return (
    <ParallaxScrollView headerBackgroundColor={{ light: '#D0D0D0', dark: '#353636' }}>
      <ThemedView style={styles.container}>
        <View style={styles.hero}>
          <ThemedText type="title">Courier</ThemedText>
          <ThemedText type="subtitle">Accept and complete orders</ThemedText>
          <ThemedText style={styles.heroCopy}>
            Connect a wallet in the Wallet tab before completing orders.
          </ThemedText>
        </View>
